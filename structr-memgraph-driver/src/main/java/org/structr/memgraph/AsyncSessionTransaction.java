...
class AsyncSessionTransaction extends SessionTransaction {
	...
	public AsyncSessionTransaction(final MemgraphDatabaseService db, final AsyncSession session) {
	...
	public AsyncSessionTransaction(final MemgraphDatabaseService db, final AsyncSession session, final int timeoutInSeconds) {
	...
	@Override
	public Iterable<Record> newIterable(final MemgraphDatabaseService db, final AdvancedCypherQuery query) {
