...
abstract class SessionTransaction implements org.structr.api.Transaction {
	...
	public SessionTransaction(final MemgraphDatabaseService db) {
	...
	public abstract Iterable<Record> newIterable(final MemgraphDatabaseService db, final AdvancedCypherQuery query);
