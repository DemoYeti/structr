...
class ReactiveSessionTransaction extends SessionTransaction {
	...
	public ReactiveSessionTransaction(final MemgraphDatabaseService db, final RxSession session) {
	...
	public ReactiveSessionTransaction(final MemgraphDatabaseService db, final RxSession session, final int timeoutInSeconds) {
